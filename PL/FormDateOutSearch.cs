...
namespace PL
{
    public partial class FormDateOutSearch : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                List<Product> _searchResult = new List<Product>(_productBl.SearchByDateOut(Convert.ToDateTime(datePicker.Value.ToShortDateString())));
