...
namespace PL
{
    public partial class FormDateComeSearch : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                List<Product> _searchResult = new List<Product>(_productBl.SearchByDateCome(Convert.ToDateTime(datePicker.Value.ToShortDateString())));
