...
namespace PL
{
    public partial class FormDateUtilizationSearch : Form
    {
        private IProductBl _productBl = new Product_BL();
        private List<Product> _allItems;
        public FormDateUtilizationSearch()
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                List<Product> _searchResult = new List<Product>(_productBl.SearchByDateUtilization(Convert.ToDateTime(datePicker.Value.ToShortDateString())));
